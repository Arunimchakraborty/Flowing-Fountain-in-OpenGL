...
GLint NumOfVerticesStone = 4;
GLfloat StoneHeight = 0.5;
GLfloat WaterHeight = 0.45;

//declaring functions part1
struct SVertex
{
	GLfloat x, y, z;
};
...
GLint Steps = 4;
GLint RaysPerStep = 16;
GLint DropsPerRay = 160;
...
void menu1()
{
	...
	glLoadName(TEXTID);
	DrawTextXY(-2.7, 3.5, 0.0, 0.003, (char*)" FOUNTAIN ");
	glColor3f(0.6, 0.8, 0.7);
	DrawTextXY(-1.25, 2.4, 0.0, 0.0014, (char*)" MENU ");
	glColor3f(1.0, 0.8, 0.4);
	DrawTextXY(-1.25, 2.1, 0.0, 0.001, (char*)" 1 : PROCEED ");
	DrawTextXY(-1.25, 1.9, 0.0, 0.001, (char*)" 2 : HELP ");
	DrawTextXY(-1.25, 1.7, 0.0, 0.001, (char*)" 3 : EXIT ");
	DrawTextXY(-1.25, 1.5, 0.0, 0.001, (char*)" 4 : BACK");
	glFlush();
	glutSwapBuffers();
}
void menu2()
{
	...
	glTranslatef(0.0, -1.3, 0.0);
	glColor3f(0.6, 0.8, 0.7);
	DrawTextXY(-2.7, 3.5, 0.0, 0.003, (char*)" HELP ");
	glColor3f(1.0, 0.8, 0.4);
	DrawTextXY(-1.75, 2.4, 0.0, 0.0014, (char*)" Keyboard Controls : ");
	glColor3f(0.9, 0.8, 0.9);
	DrawTextXY(-1.25, 2.1, 0.0, 0.001, (char*)" Move Near -> N ");
	DrawTextXY(-1.25, 1.9, 0.0, 0.001, (char*)" Move Away -> A ");
	DrawTextXY(-1.25, 1.5, 0.0, 0.001, (char*)" Move Up -> U ");
	DrawTextXY(-1.25, 1.3, 0.0, 0.001, (char*)" Move Down -> D ");
	DrawTextXY(-1.25, 0.9, 0.0, 0.001, (char*)" Top View -> T ");
	DrawTextXY(-1.25, 0.7, 0.0, 0.001, (char*)" Front View -> F ");
	DrawTextXY(-1.25, 0.3, 0.0, 0.001, (char*)" Open HELP -> H ");
	DrawTextXY(-1.25, 0.1, 0.0, 0.001, (char*)" Open MENU -> B ");
	glColor3f(0.9, 0.9, 0.8);
	DrawTextXY(1, -0.4, 0.0, 0.001, (char*)" Press any KEY ... ");
	glFlush();
	glutSwapBuffers();
}
void cover()
{
	...
	glColor3f(1.00, 0.20, 0.10);
	glLoadName(TEXTID);
	DrawTextXY(-1.7, 3.5, 0.0, 0.001, (char*)" GRAPHICAL IMPLEMENTATION OF ");
	glColor3f(0.6, 0.8, 0.7);
	DrawTextXY(-1.75, 3, 0.0, 0.0014, (char*)" FLOWING FOUNTAIN ");
	glColor3f(0.7, 0.6, 0.1);
	DrawTextXY(-3.25, 1.5, 0.0, 0.0007, (char*)" Submitted by :- ");
	glColor3f(1.0, 0.5, 0.0);
	DrawTextXY(-2.5, 1.2, 0.0, 0.001, (char*)" Arunim Chakraborty");
	DrawTextXY(1, 1.2, 0.0, 0.001, (char*)" Kshitij Shidore ");
	glColor3f(1.0, 0.5, 0.0);
	DrawTextXY(-2.5, 0.95, 0.0, 0.001, (char*)" Rupesh Dhirwani ");
	DrawTextXY(1, 0.95, 0.0, 0.001, (char*)" Atharva Khangar ");
	/*glColor3f(0.7, 0.6, 0.1);
	DrawTextXY(-1.25, 0, 0.0, 0.0007, (char*)" Under the guidance of : ");
	glColor3f(1.0, 0.8, 0.4);
	DrawTextXY(-1.25, -.2, 0.0, 0.001, (char*)" MR MUKESH KAMATH");
	DrawTextXY(-1, -.5, 0.0, 0.0007, (char*)" Lecturer,Dept. of CSE ");
	DrawTextXY(-1, -.7, 0.0, 0.001, (char*)" CITY ENGINEERING COLLEGE");*/
	glColor3f(0.3, 0.3, 0.3);
	DrawTextXY(-1, -1, 0.0, 0.0008, (char*)" Press any key... ");
	glFlush();
	glutSwapBuffers();
}
void Dis()
...
void Reshape(int x, int y)
{
	...
	glLoadIdentity();
	gluPerspective(50.0, (GLdouble)x / (GLdouble)y, 0.10, 120.0);
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("Fountain Project");
